...
const baseURLServer = [
  {
    url: `/v1`,
    description: `${capitalizeFirstLetter(config.app.name)} V1`,
  },
];
const swaggerOptURL = [
  {
    url: `/v1/api-docs.json`,
    name: `${capitalizeFirstLetter(config.app.environment)} V1`,
  },
];
...
const swaggerOptions = {
  definition: {
    ...
    info: {
      title: `Api ${config.app.name} Documentation`,
      version: "1.0.0",
    },
    paths: routesSchemas,
  },
